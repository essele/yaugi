...
module USBFS_v3_20_2 (
	...
	// VbusValid_VM (cy_virtualmux_v1_0)
	assign Net_203 = Net_287;
	...
	cy_psoc3_pins_v1_10
		#(.id("f09d1dc0-cefa-41ab-93ef-391367343dbd/618a72fc-5ddd-4df5-958f-a3d55102db42"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_m0s8_usb_v1_0 cy_m0s8_usb (
        .vbus_valid(Net_203),
        .interrupt_lo(Net_258),
        .interrupt_med(Net_259),
        .interrupt_hi(Net_237),
        .dsi_usb_sof(sof),
        .dma_req(dma_req[7:0]),
        .dp(Net_254),
        .dm(Net_235),
	...
	cy_psoc3_pins_v1_10
		#(.id("f09d1dc0-cefa-41ab-93ef-391367343dbd/8b77a6c4-10a0-4390-971c-672353e2a49c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [7:0] tmpOE__DIO_net;
	wire [7:0] tmpFB_7__DIO_net;
	wire [0:0] tmpINTERRUPT_0__DIO_net;
	electrical [0:0] tmpSIOVREF__DIO_net;

	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  .drive_mode(24'b100_100_100_100_100_100_100_100),
		...
		DIO
		 (.oe(tmpOE__DIO_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__DIO_net[7:0]}),
		  .io({Net_28[7:0]}),
		  .siovref(tmpSIOVREF__DIO_net),
		  .interrupt({tmpINTERRUPT_0__DIO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DIO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};

	wire [7:0] tmpOE__SIG_net;
	wire [7:0] tmpFB_7__SIG_net;
	wire [0:0] tmpINTERRUPT_0__SIG_net;
	electrical [0:0] tmpSIOVREF__SIG_net;

	cy_psoc3_pins_v1_10
		#(.id("4ffbfbde-d3a4-4c78-b04e-7072b73ef9f6"),
		  .drive_mode(24'b100_100_100_100_100_100_100_100),
		  .ibuf_enabled(8'b1_1_1_1_1_1_1_1),
		  .init_dr_st(8'b1_1_1_1_1_1_1_1),
		  .input_clk_en(0),
		...
		SIG
		 (.oe(tmpOE__SIG_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__SIG_net[7:0]}),
		  .io({Net_29[7:0]}),
		  .siovref(tmpSIOVREF__SIG_net),
		  .interrupt({tmpINTERRUPT_0__SIG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SIG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};
	...
	cy_psoc3_pins_v1_10
		#(.id("390cb9a7-a774-48e3-b758-475c657683ba"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("407788d6-2cff-4c3c-bffb-855291ce09b5"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    // -- TFF Start --
    reg  cy_tff_1;
    always @(posedge Net_24)
    begin
        cy_tff_1 <= Net_23^Net_27;
    end
    assign Net_27 = cy_tff_1;
    // -- TFF End --

    assign Net_23 = 1'h1;

    TCPWM_P4_v2_10_1 Timer1 (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
    ...
    USBFS_v3_20_2 USBTMC (
        .sof(Net_54),
        .vbusdet(1'b0));
    defparam USBTMC.epDMAautoOptimization = 0;
