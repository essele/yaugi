...
* Device Descriptors
*********************************************************************/
const uint8 CYCODE USBCOMP_DEVICE0_DESCR[18u] = {
...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE USBCOMP_DEVICE0_CONFIGURATION0_DESCR[39u] = {
...
*********************************************************************/
const uint8 CYCODE USBCOMP_STRING_DESCRIPTORS[27u] = {
/*********************************************************************
...
*********************************************************************/
const uint8 CYCODE USBCOMP_SN_STRING_DESCRIPTOR[22] = {
...
*********************************************************************/
const T_USBCOMP_EP_SETTINGS_BLOCK CYCODE USBCOMP_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[3u] = {
...
const uint8 CYCODE USBCOMP_DEVICE0_CONFIGURATION0_INTERFACE_CLASS[1u] = {
0xFEu
};
/*********************************************************************
...
*********************************************************************/
const T_USBCOMP_LUT CYCODE USBCOMP_DEVICE0_CONFIGURATION0_TABLE[4u] = {
    {0x01u,     &USBCOMP_DEVICE0_CONFIGURATION0_DESCR},
    {0x03u,     &USBCOMP_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE},
    {0x00u,    NULL},
    {0x00u,     &USBCOMP_DEVICE0_CONFIGURATION0_INTERFACE_CLASS}
};
/*********************************************************************
* Device Dispatch Table -- Points to the Device Descriptor and each of
*                          and Configuration Tables for this Device 
*********************************************************************/
const T_USBCOMP_LUT CYCODE USBCOMP_DEVICE0_TABLE[3u] = {
    {0x01u,     &USBCOMP_DEVICE0_DESCR},
    {0x00u,    NULL},
    {0x01u,     &USBCOMP_DEVICE0_CONFIGURATION0_TABLE}
};
/*********************************************************************
* Device Table -- Indexed by the device number.
*********************************************************************/
const T_USBCOMP_LUT CYCODE USBCOMP_TABLE[1u] = {
    {0x01u,     &USBCOMP_DEVICE0_TABLE}
};
    ...
    *  USBCOMP_GET_EXTENDED_CONFIG_DESCRIPTOR becomes the bRequest value
    *  in a host vendor device/class request
    ******************************************************************************/

    const uint8 CYCODE USBCOMP_MSOS_DESCRIPTOR[USBCOMP_MSOS_DESCRIPTOR_LENGTH] = {
    /* Descriptor Length                       */   0x12u,
    /* DescriptorType: STRING                  */   0x03u,
    /* qwSignature - "MSFT100"                 */   (uint8)'M', 0u, (uint8)'S', 0u, (uint8)'F', 0u, (uint8)'T', 0u,
                                                    (uint8)'1', 0u, (uint8)'0', 0u, (uint8)'0', 0u,
    /* bMS_VendorCode:                         */   USBCOMP_GET_EXTENDED_CONFIG_DESCRIPTOR,
    /* bPad                                    */   0x00u
    };

    /* Extended Configuration Descriptor */

    const uint8 CYCODE USBCOMP_MSOS_CONFIGURATION_DESCR[USBCOMP_MSOS_CONF_DESCR_LENGTH] = {
...
/* DIE ID string descriptor for 8 bytes ID */
    ...
    uint8 USBCOMP_idSerialNumberStringDescriptor[USBCOMP_IDSN_DESCR_LENGTH];
